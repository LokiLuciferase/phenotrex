...
cccv_scores = {'Sulfate_reducer': {0.0 : {0.0 : {'score_mean': 0.5, 'score_sd': 0.0},
                                          0.33: {'score_mean': 0.04583333333333333,
                                                 'score_sd'  : 0.044253060157839176},
                                          0.67: {'score_mean': 0.02, 'score_sd': 0.016329931618554522},
                                   ...
                                   1.0 : {0.0 : {'score_mean': 0.9264285714285714, 'score_sd': 0.06660030710912283},
